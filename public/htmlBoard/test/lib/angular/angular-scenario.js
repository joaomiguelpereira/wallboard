...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
    ...
    Scope.prototype = {
       ...
       * AngularApplication code can register a `$destroy` event handler that will give it chance to
...
angular.scenario.Application.prototype.executeAction = function(action) {
  ...
  if (!$window.document) {
    throw 'Sandbox Error: AngularApplication document not accessible.';
  }
  if (!$window.angular) {
